...
# Importing data
xmat <- read.table("C:/Users/n12027/Dropbox/Estimation comparison/Text/GitHub/MXL/xmat.csv",header=TRUE,sep=";")
ymat <- read.table("C:/Users/n12027/Dropbox/Estimation comparison/Text/GitHub/MXL/ymat.csv",header=TRUE,sep=";")
xmat=t(t(xmat))
ymat=t(t(ymat))
i=1 
...
yvec=as.vector(t(y))
yvec=t(t(yvec))
source("C:/Users/n12027/Dropbox/Estimation comparison/Text/GitHub/MXL/userin.R",local=TRUE)
testData=userin(pkg,x,yvec,nalts,nsets,nres,df)

# True Population parameters used in simulating choice data  
truebeta <- read.table("C:/Users/n12027/Dropbox/Estimation comparison/Text/GitHub/MXL/betatrue.csv",header=T, sep=";")
truebeta = t(truebeta)
truemu  = 0.5*c(-1.0,0.0,-1.0,0.0,-1.0,0.0)
